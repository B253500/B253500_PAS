...
# Transposing for similar structure to your Python output
...
## HYPOTHESIS TEST
# Function to compare biomarkers using t-test and Mann-Whitney U test
...
# Call the function with the smokers and non_smokers datasets and the list of biomarkers
